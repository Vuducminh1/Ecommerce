...
use fashionstore;
-- Tạo bảng
create table cart (id integer not null auto_increment, count integer not null, product_id integer, user_name varchar(255), primary key (id)) engine=InnoDB;
create table category (id integer not null auto_increment, category_name varchar(25), primary key (id)) engine=InnoDB;
create table `order` (id integer not null auto_increment, address varchar(50), booking_date date, country varchar(50), email varchar(25), fullname varchar(25), note varchar(80), payment_method varchar(25), phone varchar(20), status varchar(25), total integer, user_id varchar(255), primary key (id)) engine=InnoDB;
...
create table product (id integer not null auto_increment, created_at date, description varchar(500), is_active integer, is_selling integer, price integer, product_name varchar(70), quantity integer, sold integer, category_id integer, primary key (id)) engine=InnoDB;
create table product_image (id integer not null auto_increment, url_image varchar(150), product_id integer, primary key (id)) engine=InnoDB;
create table user (user_name  varchar(255) not null, avatar varchar(100), email varchar(25), login_type varchar(8), password varchar(25), phone_number varchar(20), role varchar(5), full_name varchar(25), primary key (id)) engine=InnoDB;
...
-- Insert dữ liệu
INSERT INTO `fashionstore`.`user` (`id`, `login_Type`, `role`, `password`, `full_Name`, `avatar`, `email`, `phone_Number`) VALUES ('hoanhao1512', 'default', 'user', 'MQ==', 'Võ Hoàn Hảo', 'https://haycafe.vn/wp-content/uploads/2022/02/Avatar-trang-den.png', 'haovo1512@gmail.com', '0799197703');
INSERT INTO `fashionstore`.`user` (`id`, `login_Type`, `role`, `password`, `full_Name`, `avatar`, `email`, `phone_Number`) VALUES ('admin', 'default', 'admin', 'MQ==', 'Võ Hoàn Hảo', 'https://haycafe.vn/wp-content/uploads/2022/02/Avatar-trang-den.png', 'haovo1512@gmail.com', '0799197703');
